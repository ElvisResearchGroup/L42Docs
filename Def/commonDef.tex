...
\newcommand{\MSComm}[1]{{\scriptsize \textcolor{red}{[Marco{:} #1]}}}
\newcommand{\AP}[1]{\textcolor{green}{#1}} 
\newcommand{\APComm}[1]{{\scriptsize \textcolor{green}{[Alex{:} #1]}}}
\newcommand{\KJX}[1]{\textcolor{brown}{#1}} 
\newcommand{\KJXComm}[1]{{\scriptsize \textcolor{brown}{[kjx{:} #1]}}}
\newcommand{\MAZ}[1]{\textcolor{purple}{#1}}
\newcommand{\MAZComm}[1]{{\scriptsize \textcolor{purple}{[Max{:} #1]}}}
\ifdefined\AC%
  \renewcommand{\AC}[1]{\textcolor{orange}{#1}}%
\else%
  \newcommand{\AC}[1]{\textcolor{orange}{#1}}%
\fi%
\newcommand{\ACComm}[1]{{\scriptsize \textcolor{orange}{\AC{[Andrea{:} #1]}}}}
\fi
