...
\newcommand*{\val}{\V{\NonTerminale{v}}}
...
\newcommand*{\B}[2]{QQQQQQQQ\oCurly{#1}\,{#2}\cCurly}
...
\newcommand*{\ClassName}[2]{\Aux{cname}(#1,#2)}
...
\newcommand{\Comment}[1]{%
  \scalebox{0.83}[1]{\textit{\color{darkBlue}{
  \textbf{'#1}}}}%
  }
