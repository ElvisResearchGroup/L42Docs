...
// 0
@Obj
interface Point { // static Point of(int x, int y) { return new Point() { public int x() { return
                  // x; } public int y() { return y; } }; }
  int x();
...
// 1
@Obj
interface PointSum extends Point {// static PointSum of(int x, int y) { return new PointSum() { public int x() {
                                  // return x; } public int y() { return y; } }; }
...
// 2
@Obj
interface PointSub extends Point {// static PointSub of(int x, int y) { return new PointSub() { public int x() {
                                  // return x; } public int y() { return y; } }; }
...
// 3
@Obj
interface PointMul extends Point {// static PointMul of(int x, int y) { return new PointMul() { public int x() {
                                  // return x; } public int y() { return y; } }; }
...
// 4
@Obj
interface PointDiv extends Point {// static PointDiv of(int x, int y) { return new PointDiv() { public int x() {
                                  // return x; } public int y() { return y; } }; }
...
// 5
@Obj
interface PointSumMul extends PointSum, PointMul {// static PointSumMul of(int x, int y) { return new PointSumMul() {
...
// 6
@Obj
interface PointSumSub extends PointSum, PointSub {// static PointSumSub of(int x, int y) { return new PointSumSub() {
                                                  // public int x() { return x; } public int y() { return y; } }; }
...
// 7
@Obj
interface PointSumDiv extends PointSum, PointDiv {// static PointSumDiv of(int x, int y) { return new PointSumDiv() {
                                                  // public int x() { return x; } public int y() { return y; } }; }
...
// 8
@Obj
interface PointSubMul extends PointMul, PointSub {// static PointSubMul of(int x, int y) { return new PointSubMul() {
                                                  // public int x() { return x; } public int y() { return y; } }; }
...
// 9
@Obj
interface PointSubDiv extends PointSub, PointDiv {// static PointSubDiv of(int x, int y) { return new PointSubDiv() {
                                                  // public int x() { return x; } public int y() { return y; } }; }
...
// 10
@Obj
interface PointMulDiv extends PointMul, PointDiv {// static PointMulDiv of(int x, int y) { return new PointMulDiv() {
                                                  // public int x() { return x; } public int y() { return y; } }; }
...
// 11
@Obj
interface PointSumSubDiv extends PointSumSub, PointSumDiv, PointSubDiv {// static PointSumSubDiv of(int x, int y) {
                                                                        // return new PointSumSubDiv() { public int x()
                                                                        // { return x; } public int y() { return y; } };
                                                                        // }
...
// 12
@Obj
interface PointSumSubMul extends PointSumSub, PointSumMul, PointSubMul {// static PointSumSubMul of(int x, int y) {
                                                                        // return new PointSumSubMul() { public int x()
                                                                        // { return x; } public int y() { return y; } };
                                                                        // }
...
// 13
@Obj
interface PointSumMulDiv extends PointSumMul, PointMulDiv, PointSumDiv {// static PointSumMulDiv of(int x, int y) {
                                                                        // return new PointSumMulDiv() { public int x()
                                                                        // { return x; } public int y() { return y; } };
                                                                        // }
...
interface PointSubMulDiv extends PointSubMul, PointMulDiv, PointSubDiv {
  // static PointSubMulDiv of(int x, int y) { return new PointSubMulDiv() { public
  // int x() { return x; } public int y() { return y; } }; }
...
// 15
@Obj
interface PointSumSubMulDiv extends PointSumSubMul, PointSumMulDiv, PointSumSubDiv, PointSubMulDiv {// static
                                                                                                    // PointSumSubMulDiv
                                                                                                    // of(int x, int y)
                                                                                                    // { return new
                                                                                                    // PointSumSubMulDiv()
